...
|   |   |
| --- | --- |
| 🏛️[`datasets`](./dataset) [![image](https://github.com/kamangir/assets/blob/main/roofAI/AIRS-cache-v45--review-index-2.png?raw=true)](./dataset) Semantic Segmentation Datasets | 🏛️[`semseg`](./semseg) [![image](./assets/predict-00247.png)](./semseg) A Semantic Segmenter based on [segmentation_models.pytorch](<https://github.com/qubvel/segmentation_models.pytorch/blob/master/examples/cars%20segmentation%20(camvid).ipynb>). |
...
built by 🌀 [`blue_options-4.223.1`](https://github.com/kamangir/awesome-bash-cli), based on 🏛️ [`roofai-6.86.1`](https://github.com/kamangir/roofai).
