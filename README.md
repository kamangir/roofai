...
|  | [`Google Earth API`](./roofai/google_earth/api) [![image](https://github.com/kamangir/assets/raw/main/roofAI/google_earth/glb-viewer.png?raw=true)](./roofai/google_earth/api) Integration with the [Google Photorealistic 3D Tiles](https://developers.google.com/maps/documentation/tile/3d-tiles-overview) API. |
...
built by 🌀 [`blue_options-4.223.1`](https://github.com/kamangir/awesome-bash-cli), based on 🏛️ [`roofai-6.264.1`](https://github.com/kamangir/roofai).
