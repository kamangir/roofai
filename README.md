...
| [``](#) [![image](https://github.com/kamangir/assets/raw/main/blue-plugin/marquee.png?raw=true)](#)  | [`Google Earth API`](./roofai/google_earth/api) [![image](https://github.com/kamangir/assets/raw/main/roofAI/google_earth/glb-viewer.png?raw=true)](./roofai/google_earth/api) Integrations with [Google Maps Tile API, Photorealistic 3D Tiles overview](https://developers.google.com/maps/documentation/tile/3d-tiles-overview). |
...
built by 🌀 [`blue_options-4.223.1`](https://github.com/kamangir/awesome-bash-cli), based on 🏛️ [`roofai-6.260.1`](https://github.com/kamangir/roofai).
